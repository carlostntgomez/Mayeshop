        ...
        return $form
            ->schema([
                Section::make('Detalles de la Categoría')
                    ->description('Información básica y SEO para la categoría del blog.')
                    ->schema([
                        TextInput::make('name')
                            ->label('Nombre')
                            ->required()
                            ...
                            ->hintAction(
                                Action::make('name_hint')
                                    ...
                                    ->tooltip('Introduce el nombre de la categoría para el blog. Este nombre será visible para los visitantes (ej: Noticias, Tutoriales, Casos de Éxito).')
                            ),
                        TextInput::make('slug')
                            ->label('Slug')
                            ->required()
                            ...
                            ->hintAction(
                                Action::make('slug_hint')
                                    ->label('')
                                    ->icon('heroicon-o-question-mark-circle')
                                    ->tooltip('El slug es la parte de la URL que identifica a la categoría del blog. Se genera automáticamente, pero puedes ajustarlo.')
                            ),
